...
- Why this hits hard: most products throw away their best signal. A correction is proprietary training data nobody else has — if you don't capture it, you're burning your own moat. This is the slide where people realize they're sitting on a goldmine they're not mining
...
- Interactive: "Where does your product sit? Point to a spot." Get 2-3 answers
- Why this visual: Daria's feedback was right — the old slide was too text-heavy. The spectrum makes it instantly intuitive. If you're on the left, anyone can replace you. If you're on the right, replacing you means rebuilding the user's entire process
...
## Slide 7 — Case Study: Jasper vs. ChatGPT
...
- Correction: pivoted to enterprise marketing workflows. Gokul said "from 1 to 100 and 100 to 40"
- Why Jasper: most vivid example of a wrapper getting eaten alive, in real time. The lesson isn't "Jasper failed" — it's "features get eaten, workflows survive." Saying you have a moat is not the same as having one
- Ask the room: "Where is your product a wrapper vs. a workflow?"

## Slide 8 — Data Flywheel Scoring
- Four loops: Correction, Preference, Domain Context, Network
- Score each 1-5. Weakest loop = where competitors attack first
- Why a scoring tool: abstract concepts don't change behavior, numbers do. Once they see a 1 or 2 staring back at them, the priority becomes obvious

## Slide 9 — Break
- 5 min. When they come back: all applied work

## Slide 10 — Map Your Data Flywheel
...
## Slide 11 — Encroachment Threat Assessment
...
## Slide 12 — The 90-Day Encroachment Plan (Peer Challenge)
...
## Slide 14 — Your Portability Audit
