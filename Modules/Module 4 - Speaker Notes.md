...
**Teaching:** Nothing new — this is structural orientation. The agenda shows the interleaved flow: concept → build → break → concept + case → build → concept → challenge → build. Signal that today alternates between learning and doing — no long lecture stretches.

**Doing:** Presentation, quick scan. Pre-frame the red-team exercise as "sport, not judgment" so nobody gets anxious about it. Don't linger — under 1 minute.
...
### Slide 7 — Golden Dataset (Applied)
...
### Slide 9 — Human-in-the-Loop Design
...
### Slide 10 — Case Study: Air Canada
...
### Slide 11 — Confidence UX (Applied)
...
**Teaching:** Close the loop to slide 4. They walked in thinking trust = accuracy; they're leaving with an audit trail — golden dataset spec, confidence UX, reliability contract. Component 4 of the living strategy is now tangible specs, not feelings.
...
**Teaching:** Three interactive tools available for continued work: Golden Dataset Builder, Confidence UX Checklist, and Living Strategy Builder (to add Component 4).

**Doing:** Quick pointer — 30 seconds. Mention that data saves to the browser and carries forward to M5.
