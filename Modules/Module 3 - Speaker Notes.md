...
## Slide 7 — How You Charge > How Much
...
- **Interactive:** pair 45 sec — is your hero SKU closer to access (left) or outcome (right)?
- Why we teach this: PMs default to seat pricing because it's what they know. But AI often delivers *work*, not access. If you price access on a product that does work, you leave massive value on the table. The Intercom example proves outcome pricing works

## Slide 8 — Leaders, Fillers & Killers
...
## Slide 15 — Build Moment (Board One-Pager)
